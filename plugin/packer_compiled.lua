...
_G.packer_plugins = {
  ...
  ["adwaita.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/adwaita.nvim",
  ...
  ["everforest-nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/everforest-nvim",
    url = "https://github.com/neanias/everforest-nvim"
  },
  fd = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["monokai.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/monokai.nvim",
  ...
  ["themer.lua"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/themer.lua",
  ...
  ["vim-which-key"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-which-key",
